<h1>Проект Weather</h1>
<h3>Выполнил: Лапухин Артём Андреевич</h3>
<h3><b>Помечается гуглом как вирус</b>,почему - не знаю. Первый комит проходит, а второй нет, хотя там были добавлены только компоненты написанные мной</h3>
